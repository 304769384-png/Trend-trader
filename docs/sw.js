/**
 * Service Worker - 离线缓存支持 (v8 优化版)
 * 趋势交易助手 PWA
 * 适配 Safari 桌面 + 腾讯云静态托管
 */

const CACHE_NAME = 'trend-trader-v21.8';
// 核心资源预缓存（包含所有图标尺寸）
const CORE_ASSETS = [
  './',
  './index.html',
...
self.addEventListener('fetch', event => {
  ...
  // 其他同源静态资源（JS/CSS/图标等）: Network-First，失败回缓存
  // 确保每次打开都使用最新代码，避免设置保存失败等缓存导致的问题
